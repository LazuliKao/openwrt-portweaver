...
export default function (
  ...
  addFrpNodeConfigSource(ss, "frpc");
  ...
  oServer.depends("config_mode", "builtin");
  ...
  oPort.depends("config_mode", "builtin");
  ...
  oToken.depends("config_mode", "builtin");
  ...
  oLogLevel.depends("config_mode", "builtin");
  ...
  async function pollFrpStatus() {
    try {
      const nodes = (await L.uci.sections("portweaver", "frpc_node")).map(
        (sec: any) => ({
